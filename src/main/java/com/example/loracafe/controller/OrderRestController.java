...
import com.example.loracafe.entity.Pedido.EstadoPedido;
import com.example.loracafe.service.PedidoService;
...
public class OrderRestController {
    ...
    public ResponseEntity<Page<Pedido>> getAllPedidos(
        ...
        if (date != null && !date.isEmpty()) {
            try {
                ...
                spec = spec.and((root, query, cb) -> cb.between(root.get("fechaPedido"), localDate.atStartOfDay(),
    ...
    public ResponseEntity<Pedido> updateOrderStatus(@PathVariable Integer id,
